...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get drawerHoldToReorder =>
      'Удерживайте элемент, чтобы перетащить и изменить порядок';
  ...
  @override
  String get onbWhatsInside => 'Что вы можете делать';
  ...
  @override
  String get onbSwipeHint => 'Смахните, чтобы посмотреть';

  @override
  String get onbDeepWelcome =>
      'Расписание, оценки, домашние задания, сообщения и конспекты — всё здесь, один вход для школы. Вот краткий обзор.';

  @override
  String get onbDeepNova =>
      'Спросите NOVA о чём угодно своими словами и получите пошаговое объяснение. Превратите тему в задания, сохраните нужные вопросы и сфотографируйте задачу, которая не выходит, чтобы разобрать её.';
  ...
  String get onbDeepTeacherClasses =>
      'Откройте класс, чтобы увидеть состав, отметьте посещаемость в пару касаний, выдайте задания и материалы и держите списки групп в порядке.';

  @override
  String get onbDeepTeacherGrading =>
      'Выставляйте оценки по своей шкале, публикуйте, когда готовы, а Insights покажет, кто отстаёт, пока это не стало проблемой.';

  @override
  String get onbDeepTeacherComms =>
      'Опубликуйте объявление для всей группы, напишите родителю или ученику, назначьте встречу и соберите ответы через форму.';

  @override
  String get onbDeepAdminOps =>
      'Управляйте школой с одной панели: составьте расписание, задайте шкалы оценок, просматривайте отчёты и выгружайте нужные данные.';

  @override
  String get onbDeepAdminPeople =>
      'Добавляйте учеников, учителей и родителей, распределяйте по группам, связывайте родителя с ребёнком и выдавайте свидетельства в конце года.';

  @override
  String get onbDeepSecretary =>
      'Держите день под контролем: правьте расписание, добавляйте и обновляйте записи людей, выдавайте справки и быстро публикуйте объявления.';

  @override
  String get onbDeepParentChild =>
      'Переключайтесь между детьми и смотрите для каждого расписание, оценки, посещаемость и домашние задания — ту же картину, что видит школа.';
