...
class ChatMessageBubble extends StatelessWidget {
  ...
  bool _forceHideMediaText({
    ...
    if (isMediaMessage && _looksLikeFileName(b)) {
      return true;
    }
  ...
  Widget build(BuildContext context) {
    ...
    final isImage =
        hasMedia && (_isImageByUrl(lowerUrl) || _isImageByMeta(messageKind, resolvedMime));
    final isVoice =
        hasMedia && (_isVoiceByUrl(lowerUrl) || _isVoiceByMeta(messageKind, resolvedMime));
    final isPdf =
        hasMedia && (_isPdfByUrl(lowerUrl) || resolvedMime.toLowerCase().contains('pdf'));
    final isVideo =
        hasMedia && (_isVideoByUrl(lowerUrl) || _isVideoByMeta(messageKind, resolvedMime));
