...
class ChatMessageBubble extends StatelessWidget {
  ...
  bool _shouldHideAutogeneratedMediaLabel({
    ...
    if (upperKind == 'IMAGE' ||
        ...
        upperKind == 'VOICE' ||
        upperKind == 'FILE') {
      final fileName = Uri.tryParse(resolvedMediaUrl)?.pathSegments.isNotEmpty == true
          ? Uri.parse(resolvedMediaUrl).pathSegments.last.trim()
          : '';
      ...
      return normalizedBody == fileName ||
          ...
          normalizedBody == fileName.replaceAll('%20', ' ') ||
          normalizedBody == decoded.replaceAll('_', ' ');
    }
