            ...
            <div className="mt-3 grid gap-3 md:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  placeholder="parent1@classmate.app"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  placeholder="student1@classmate.app"
                />
              </div>
            </div>
            <div className="mt-3">
              <button
                ...
                onClick={link}
                disabled={!parentEmail.trim() || !studentEmail.trim()}
              >
                Link
              </button>
            </div>
            <div className="mt-2 text-xs text-gray-500">
              If this endpoint doesn’t exist yet, we add it in API next.
            </div>
          </div>
        </div>
      </AdminShell>
