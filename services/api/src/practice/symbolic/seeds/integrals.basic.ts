...
export const INTEGRALS_BASIC_SEEDS: SymbolicQuestionSeed[] = [
  {
    ...
    options: ['$\\frac{x^{2}}{2} + C$', '1', '$x + C$', '$2x + C$'],
    correctIndex: 0,
    explanation: 'Using the power rule for integrals, $\\int x\\,dx = \\frac{x^{2}}{2} + C$.',
  ...
  {
    stem: 'What is $\\int 3x^{2}\\,dx$ ?',
    options: ['$x^{3} + C$', '$3x + C$', '$6x + C$', '$x^{2} + C$'],
    correctIndex: 0,
    explanation: 'Since $\\frac{d}{dx}(x^{3})=3x^{2}$, the antiderivative is $x^{3} + C$.',
    recommendedTimeSeconds: 35,
  },
  {
